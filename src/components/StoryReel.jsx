    ...
    <div className="story-reel-container">
      <div className="story-reel">
        ...
        {stories.map((story, index) => ( // Dodano indeks dla bardziej opisowej etykiety aria w razie potrzeby.
          ...
          >
            <div className={`story-circle ${story.viewed ? 'viewed' : ''} ${story.type === 'video' ? 'video' : ''}`}>
              <img src={story.type === 'video' ? story.thumbnail : story.src} alt={`Story ${index + 1} thumbnail`} className="story-thumbnail" />
            </div>
